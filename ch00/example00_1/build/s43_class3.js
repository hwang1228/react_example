...
var Employees = function (_Person) {
    _inherits(Employees, _Person);

    function Employees(name, tel, address, empno, dept) {
        _classCallCheck(this, Employees);

        var _this = _possibleConstructorReturn(this, (Employees.__proto__ || Object.getPrototypeOf(Employees)).call(this, name, tel, address));
    ...
    _createClass(Employees, [{
        key: "toString",
        value: function toString() {
            return _get(Employees.prototype.__proto__ || Object.getPrototypeOf(Employees.prototype), "toString", this).call(this) + (", empno=" + this.empno + ", dept=" + this.dept);
        }
    }, {
        key: "getEmpInfo",
